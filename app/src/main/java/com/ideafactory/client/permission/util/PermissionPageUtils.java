package com.ideafactory.client.permission.util;
...
/**
 * Created by maolin on 2018/10/17.
 *
 * 跳转至不同厂商应用权限设置页面
 */
...
public class PermissionPageUtils {
    ...
    public static PermissionPageUtils getInstance(Context context, String packageName){
        if (permissionPageUtils==null){
            permissionPageUtils=new PermissionPageUtils(context,packageName);
        }
