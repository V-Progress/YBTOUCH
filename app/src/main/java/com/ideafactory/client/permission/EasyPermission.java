package com.ideafactory.client.permission;
...
import com.ideafactory.client.permission.annotation.OnEasyPermissionFailed;
import com.ideafactory.client.permission.annotation.OnEasyPermissionSuccess;
...
public class EasyPermission {
    ...
    private static OnEasyPermissionResult permissionResult=null;
    public static void setOnEasyPermissionResult(OnEasyPermissionResult easyPermissionResult){
        permissionResult=easyPermissionResult;
    }
    /**
     * 回调成功方法
     *
    ...
    private static void doExecuteSuccess(Activity activity, int requestCode) {
        if (permissionResult!=null){
            permissionResult.OnEasyPermissionSuccess(activity,requestCode);
        }else {
    ...
    private static void doExecuteFail(Activity activity, int requestCode) {
        if (permissionResult!=null){
            permissionResult.OnEasyPermissionFailed(activity,requestCode);
        }else {
            executeMethod(activity, EasyPermissionUtil.findMethodWithRequestCode(activity.getClass(),
