package com.ideafactory.client.util.logutils;
...
public class Utils {
     ...
     * @param path
     */
    static void createDirs(File path) {
    ...
    private static boolean isAlphanumeric(char ch) {
        ...
        return ch <= DIGITAL_NINE || ch >= MIN_LOWERCASE && ch <= MAX_LOWERCASE || ch >= MIN_UPPERCASE && ch <= MAX_UPPERCASE;
    }
