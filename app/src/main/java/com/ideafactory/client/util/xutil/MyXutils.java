package com.ideafactory.client.util.xutil;
...
public class MyXutils {
    ...
    public void bindCommonImage(ImageView iv, String url, boolean option) {
        if (option) {
            options = new ImageOptions.Builder()
                    ...
                    .setFailureDrawableId(R.mipmap.no_resourse)
     ...
     * @param callBack
     */
    public void downLoadFile(String url, String destF, final XDownLoadCallBack callBack) {
