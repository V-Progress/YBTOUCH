package com.ideafactory.client.util.screen;
...
import com.ideafactory.client.common.power.ZHBroadControl;
...
public class ScreenShot {
    ...
    private void cutA20Screen() {
        try {
            ...
            if (!TextUtils.isEmpty(hwrotation)) {
                ...
                int rotation = BaseActivity.getActivity().getWindowManager().getDefaultDisplay().getRotation();
    ...
    public Bitmap snapShotWithStatusBar() {
        View view = BaseActivity.getActivity().getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
        Bitmap bmp = view.getDrawingCache();
        DisplayMetrics dm = new DisplayMetrics();
        BaseActivity.getActivity().getWindowManager().getDefaultDisplay().getMetrics(dm);
