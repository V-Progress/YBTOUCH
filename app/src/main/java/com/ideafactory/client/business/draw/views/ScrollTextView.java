...
public class ScrollTextView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    private int backColor = getResources().getColor(R.color.white);
    ...
    public ScrollTextView(Context context, AttributeSet attrs) {
        ...
        this.mDirection = 0;
        this.mScrollSpeed = 1;
        this.setOnTouchListener(new ScrollTextView.TextTouchListener());
    }
        ...
        public boolean onTouch(View context, MotionEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (this.mMode == 1) {
                        int direction = ScrollTextView.this.mDirection;
                        float i = 0.0F;
                        switch (direction) {
                            case 0:
