...
import com.ideafactory.client.business.unicomscreen.onDeviceIsOnline;
...
public class ClientSide {
    ...
    private class ClientHeartThread extends Thread {
        public void run() {
            while (true) {
                ...
                if (onDeviceisOnline!=null){
                    onDeviceisOnline.onDeviceIsOnline(isConnected);
    ...
    public static onDeviceIsOnline onDeviceisOnline;

    public static void setOnDeviceIsOnlineListener(onDeviceIsOnline mOnDeviceisOnline) {
        onDeviceisOnline = mOnDeviceisOnline;
    }
}
