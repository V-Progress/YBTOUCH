...
class JYDBroadControl {
    ...
    JYDBroadControl() {
        String on = PowerOffTool.getPowerOffTool().getPowerParam(PowerOffTool.POWER_ON); //1,2,3,4,5,6,7;08:00
        String off = PowerOffTool.getPowerOffTool().getPowerParam(PowerOffTool.POWER_OFF);
